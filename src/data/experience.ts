  ...
  },
  {
    ...
    highlights: [
      ...
      },
     {
        ...
        text: 'Built an automated K-Means clustering model in Python (pandas, NumPy) with dynamic cluster selection, validating results via PCA to cut manual analysis time by 10% for client sales strategy.',
      },
      {
